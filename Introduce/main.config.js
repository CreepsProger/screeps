	...
	init: function() {
	  ...
	  if(!Memory.config ||
			...
			,	main_path:{ W29S37: 'W28S37'
									...
									, W23S28: 'W23S29', W23S29: 'W24S29', W24S29: 'W24S28', W24S29x:37
				 	...
				 	{	defaults:
						...
						rooms:
						{
							...
							, path_rooms:
								...
								, escape_path:
								{ W24S27: 'W25S27', W25S27: 'W25S28', W25S28: 'W26S28', W26S27: 'W26S28', W26S28: 'W26S29', W26S29: 'W27S29', W27S29: 'W28S29', W28S29: 'W29S29'
								}
							},
							W26S28:
						  ...
						  , heal_room: 'W29S32'
							, path_rooms:
							 	{ shard0:
								  ...
								  , W57S51: 'W58S51', W58S51: 'W59S51', W59S50: 'W60S50', W60S50: 'shard1'
									}
								, shard1:
