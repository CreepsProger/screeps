var roleEnergyHarvester = {
    ...
    run: function(creep) {
        ...
        var maxHarvesterMovementsToSource = Math.floor(1.5 * Memory.harvestersMovements.Value.movingAverage.delta / Memory.harvestersMovements.Count.movingAverage.delta);
