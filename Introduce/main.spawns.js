...
var spawns = {
   ...
   work_efficiency: function(type,range) {
	...
	ATTACKER: [ [                 0,                0,                0]  // 0  000
						...
						, [  1000000030000010,  500003005000010,  500300005000010,   50000005100020]//11 
						, [  1000000030000010, 1000002505000010, 1000250005000010, 1000000005250010]//12
						, [  1700000023000010, 1700002300000010, 1700230000000010, 1200000008200010]//13
		...
		// for(var name in Game.spawns)
     {
			...
			if(!spawn.spawning && Nspawns) {
				...
				const Sp15= (Game.shard.name == 'shard0')? (All || spawn.name == 'Spawn--' || spawn.name == 'Spawn--' || spawn.name == 'Spawn--'):
				         		(Game.shard.name == 'shard1')? (All || spawn.name == 'Spawn42' || spawn.name == 'Spawn--' || spawn.name == 'Spawn--'):
				            (Game.shard.name == 'shard3')? (All || spawn.name == 'Spawn--' || spawn.name == 'Spawn--' || spawn.name == 'Spawn--'):All;
        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S28')) {
						...
						if(Sp6 && !All && tm == 4) spawns.tryCreateCreep(spawn, ATTACKER[13][L], 206);
						if(Sp6 && !All && tm == 5) spawns.tryCreateCreep(spawn, ATTACKER[13][M], 207);
						if(Sp6 && !All && tm == 6) spawns.tryCreateCreep(spawn, ATTACKER[13][H], 208);
						if(Sp6 && !All) spawns.tryCreateCreep(spawn, ATTACKER[13][L], 206);
						if(Sp6 && !All) spawns.tryCreateCreep(spawn, ATTACKER[13][M], 207);
						if(Sp6 && !All) spawns.tryCreateCreep(spawn, ATTACKER[13][H], 208);
						if(Sp6 && !All) spawns.tryCreateCreep(spawn, ATTACKER[13][S], 204);
						
						if(Sp6 && !All && tm == 4) spawns.tryCreateCreep(spawn,CLAIMER[5][H], 210);
						if(Sp6 && !All && tm == 5) spawns.tryCreateCreep(spawn, WORKER[7][M], 214);
						if(Sp6 && !All && tm == 6) spawns.tryCreateCreep(spawn, CARIER[7][L], 211);
            ...
            if(Sp14)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 5451);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S29')) {
						...
						if(Sp6 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5402);
					}
					else {
						if(Sp6 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5402);
						if(Sp6 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5404);
						if(Sp6 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5401);
						if(Sp6 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[M], 5405);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S23')) {
						...
						if(Sp15 && !All)	spawns.tryCreateCreep(spawn, WORKER[6][M], 5412);
						if(Sp6 && !All)		spawns.tryCreateCreep(spawn, WORKER[7][M], 5412);
					}
					else {
						if(Sp15 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[12][L], 5416);
						if(Sp15 && !All)	spawns.tryCreateCreep(spawn, WORKER[6][M], 5412);
						if(Sp6 && !All)		spawns.tryCreateCreep(spawn, WORKER[7][M], 5412);
						if(Sp15 && !All)	spawns.tryCreateCreep(spawn, WORKER[6][H], 5414);
						if(Sp6 && !All)		spawns.tryCreateCreep(spawn, WORKER[7][M], 5414);
						if(Sp15 && !All)	spawns.tryCreateCreep(spawn, CARIER[6][H], 5411);
						if(Sp6 && !All)		spawns.tryCreateCreep(spawn, CARIER[7][L], 5411);
						//if(Sp15 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 5415);
						if(Sp15 && !All)	spawns.tryCreateCreep(spawn, WORKER[6][H], 5415);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S24')) {
						...
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S24')) {
							if(Sp15)	spawns.tryCreateCreep(spawn, CLAIMER[6][M], 5420);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5424);
						if(Sp15)	spawns.tryCreateCreep(spawn, CARIER[6][L], 5421);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S22')) {
						if(Sp15)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5437);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S22')) {
							if(Sp15)	spawns.tryCreateCreep(spawn, CLAIMER[6][M], 5430);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5434);
						if(Sp15)	spawns.tryCreateCreep(spawn, CARIER[6][L], 5431);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S23')) {
						if(Sp15)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5447);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S23')) {
							if(Sp15)	spawns.tryCreateCreep(spawn, CLAIMER[6][M], 5440);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5444);
						if(Sp15)	spawns.tryCreateCreep(spawn, CARIER[6][L], 5441);
					}
					if(Sp6 && !All) spawns.tryCreateCreep(spawn, CARIER[7][L], 203);
					if(Sp6 && !All) spawns.tryCreateCreep(spawn, WORKER[1][L], 209);
					if(Sp6 && !All) spawns.tryCreateCreep(spawn, WORKER[1][L], 219);
				}
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp7)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 621);
						...
						if(conditions.TO_SPAWN_ROOM_DEFENDERS('W52S54')) {
							...
							if(Sp7)	spawns.tryCreateCreep(spawn,  UPGRADER[L], 675);
						}
						if(conditions.TO_SPAWN_ROOM_DEFENDERS('W51S54')) {
							if(Sp7)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 777);
						}
						else {
							if(conditions.TO_SPAWN_ROOM_CLAIMER('W51S54')) {
								if(Sp7)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 770);
							}
							if(Sp7)	spawns.tryCreateCreep(spawn, WORKER[7][M], 774);
							if(Sp7)	spawns.tryCreateCreep(spawn, CARIER[7][L], 771);
							//if(Sp7)	spawns.tryCreateCreep(spawn,  UPGRADER[L], 775);
						}
					}
            ...
            if(Sp9)	spawns.tryCreateCreep(spawn, CARIER[7][L], 741);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W57S56')) {
						if(Sp10)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 757);
					}
					else {
						if(Sp10)	spawns.tryCreateCreep(spawn, WORKER[7][M], 755);
            if(Sp10)	spawns.tryCreateCreep(spawn, CARIER[7][L], 751);
						if(Sp10)	spawns.tryCreateCreep(spawn,  UPGRADER[L], 765);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W54S557')) {
						if(Sp7 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 767);
					}
					else {
						if(Sp7 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 764);
            if(Sp7 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 761);
						if(Sp7 && !All)	spawns.tryCreateCreep(spawn,  UPGRADER[L], 765);
					}
