        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S29')) {
						...
						if(Sp2)	spawns.tryCreateCreep(spawn, WORKER[6][M], 5024, 3, 3);
						if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[4][H], 5021, 2-m+p, 2-m+p);
					}
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S29')) {
						...
						if(Sp2)	spawns.tryCreateCreep(spawn, WORKER[6][L], 5054, 4-n+r, 4-n+r);
						const m = 0+!!flags.flags['-5051'];
						const p = 0+!!flags.flags['5051'];
						if(Sp2)	spawns.tryCreateCreep(spawn, CARIER[5][M], 5051, 1-m+p, 1-m+p);
					}/*
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S29')) {
						if(Sp2)	spawns.tryCreateCreep(spawn, ATTACKER[4][M], 5065, 1, 1);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W27S29')) {
							//if(Sp1)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 5060, 1, 1);
							if(Sp2)	spawns.tryCreateCreep(spawn, CLAIMER[5][H], 5060, 1, 1);
						}
						...
						if(Sp2)	spawns.tryCreateCreep(spawn, CARIER[5][L], 5061, 1-m+p, 1-m+p);
					}*/
        }
          ...
          if(Sp1)	spawns.tryCreateCreep(spawn, CARIER[6][L], 461, 1, 1);*/
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S33')) {
								if(spawn.name == 'Spawn1') spawns.tryCreateCreep(spawn, ATTACKER[1][L], 35, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S33')) {
								if(spawn.name == 'Spawn2') spawns.tryCreateCreep(spawn, ATTACKER[4][L], 45, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S33')) {
								if(spawn.name == 'Spawn3') spawns.tryCreateCreep(spawn, ATTACKER[4][L], 65, 1, 1);
	            ...
	            if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S33')) {
								if(spawn.name == 'Spawn2') spawns.tryCreateCreep(spawn, ATTACKER[4][L], 55, 1, 1);
	              ...
	              if(Sp23)	spawns.tryCreateCreep(spawn, CARIER[7][M], 51, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S35')) {
								if(spawn.name == 'Spawn4') spawns.tryCreateCreep(spawn, ATTACKER[4][L], 125, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S32')) {
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn, ATTACKER[4][L], 175, 1, 1);
