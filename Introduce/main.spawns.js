    ...
    const I = Game.time % constants.TICKS_TO_SPAWN;
		...
		// for(var name in Game.spawns)
     {
			...
			if(!spawn.spawning && Nspawns) {
				...
				const Sp3 = (Game.shard.name == 'shard0')? (All || spawn.name == 'Spawn5'  || spawn.name == 'Spawn--' || spawn.name == 'Spawn--'):
				...
				const Sp6 = (Game.shard.name == 'shard0')? (All || spawn.name == 'Spawn--' || spawn.name == 'Spawn--' || spawn.name == 'Spawn--'):
				         		(Game.shard.name == 'shard1')? (All || spawn.name == 'Spawn11' || spawn.name == 'Spawn15' || spawn.name == 'Spawn--'):
				...
				const Sp7 = (Game.shard.name == 'shard0')? (All || spawn.name == 'Spawn--' || spawn.name == 'Spawn--' || spawn.name == 'Spawn--'):
				         		(Game.shard.name == 'shard1')? (All || spawn.name == 'Spawn14' || spawn.name == 'Spawn18' || spawn.name == 'Spawn--'):
				...
				const ATTACKER = [ [                0,                0,                0]  // 0  000
												 ...
												 , [     250008000017,     200013000017,     300010000010 // 8 12900
												   ...
												   ,     170008000025,     170008000025,     170008000025]
													...
													, [ 1100002110000006, 1000200010000010, 1500000025000010, 3800000000050007]
        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W23S28')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5165);
					}
					else {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S29')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5235);
					}
					else {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S27')) {
						if(Sp7)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5206);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W25S27')) {
							if(Sp7)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 5200);
						}
						if(Sp7)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5205);
						if(Sp7)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5204);
						if(Sp7)	spawns.tryCreateCreep(spawn, CARIER[6][L], 5201);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S27')) {
						if(Sp7)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5195);
					}
					else {
					...
					if(spawn.name == 'Spawn10' || spawn.name == 'Spawn9' || spawn.name == 'Spawn16') spawns.tryCreateCreep(spawn,   ATTACKER[10][H], 5267);
					if(spawn.name == 'Spawn10' || spawn.name == 'Spawn9' || spawn.name == 'Spawn16') spawns.tryCreateCreep(spawn,   ATTACKER[10][M], 5266);
					if(spawn.name == 'Spawn10' || spawn.name == 'Spawn9' || spawn.name == 'Spawn16') spawns.tryCreateCreep(spawn,   ATTACKER[10][L], 5265);
					if(spawn.name == 'Spawn10' || spawn.name == 'Spawn9' || spawn.name == 'Spawn16') spawns.tryCreateCreep(spawn,   ATTACKER[10][S], 5264);
        }
				...
				if(Game.shard.name == 'shard0') {
					...
					if(true) {
						...
						if(Sp2)	spawns.tryCreateCreep(spawn, CARIER[7][M], 451); // 2
					}
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W55S51')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[4][M], 465);
					}
					else {
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp2)	spawns.tryCreateCreep(spawn, CARIER[7][L], 491); // 2
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W54S51')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 525);
					}
					else {
            ...
            if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[6][H], 521);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W52S51')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 535);
					}
					else {
            ...
            if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[6][L], 531);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W53S51')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 545);
					}
					else {
