...
/*
			...
			if(!spawn.spawning && spawn.name != 'Spawn19') {
				...
				if(false) {
					...
					spawns.tryCreateCreep(spawn,           150510, 39, 1); // V 1-2 E    Worker
					spawns.tryCreateCreep(spawn,             1608, 41, 4); // V 1-1 E    Carier
