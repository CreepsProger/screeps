...
// 						W21S23_NA.setColor(COLOR_GREEN);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S21')) {
						...
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5585);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W23S21')) {
						...
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5595);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5594);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S21')) {
						...
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5605);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5604);
...
// 						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 845);
						if(Sp12 && !All && upgrade)	spawns.tryCreateCreep(spawn, UPGRADER[L], 845);
					}
