        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S31')) {
						...
						if(Sp4)	spawns.tryCreateCreep(spawn, WORKER[6][M], 5084, !W?1:W.color, !W?1:W.secondaryColor);
						const C = flags.flags['5081'];
						if(Sp4)	spawns.tryCreateCreep(spawn, CARIER[6][H], 5081, !C?1:C.color, !C?1:C.secondaryColor);
					}
