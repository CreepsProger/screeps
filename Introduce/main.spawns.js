        ...
        const CARIER = [ [     0,      0,      0]  // 0  000
				...
				if(Game.shard.name == 'shard0') {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W57S52')) {
						...
						if(Sp1) spawns.tryCreateCreep(spawn, WORKER[4][M], 404, 4, 4);
						if(Sp1) spawns.tryCreateCreep(spawn, CARIER[4][H], 401, 1, 1);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W57S53')) {
						...
						if(Sp1)	spawns.tryCreateCreep(spawn, CARIER[4][L], 411, 1, 1);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W58S52')) {
						...
						if(Sp1)	spawns.tryCreateCreep(spawn, CARIER[4][L], 421, 1, 1);
					}
