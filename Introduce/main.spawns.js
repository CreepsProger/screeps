        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S27')) {
						...
						if(Sp11)	spawns.tryCreateCreep(spawn, WORKER[6][H], 5144);
						if(Sp11)	spawns.tryCreateCreep(spawn, CARIER[6][H], 5141);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S27')) {
						...
						if(Sp10)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5294);
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp4)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 561);
              ...
              if(Sp4)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 590);
						...
						if(Sp4)	spawns.tryCreateCreep(spawn, WORKER[5][M], 594);
