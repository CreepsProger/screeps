		...
		// for(var name in Game.spawns)
     {
        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
  					...
  					if(Sp1 || Sp2) spawns.tryCreateCreep(spawn, CARIER[7][M], 5011);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S29')) {
						...
						if((Sp1 || Sp2 || Sp3) && !All)	spawns.tryCreateCreep(spawn, CARIER[7][M], 5021);
						if(Sp2 && upgrade && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 5025);
					}
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S29')) {
						...
						if((Sp1 || Sp2 || Sp3) && !All)	spawns.tryCreateCreep(spawn, CARIER[7][M], 5051);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S29')) {
						if(Sp23 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5077);
					}
					else {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S27')) {
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5107);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W27S27')) {
							if(Sp11 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 5100);
						}
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5104);
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5101);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S28')) {
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5117);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W27S28')) {
							if(Sp11 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 5110);
						}
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5114);
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5111);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S28')) {
						if(Sp11 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5137);
					}
					else {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W23S28')) {
						if(Sp5 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5167);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W23S28')) {
							if(Sp5 && !All) spawns.tryCreateCreep(spawn, CLAIMER[7][M], 5160);
						}
						if(Sp5 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5164);
						if(Sp5 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5161);
					}
...
// 						W21S23_NA.setColor(COLOR_GREEN);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S21')) {
						...
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5589);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5584);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5581);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W23S21')) {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5597);
					}
					else {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S21')) {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5607);
					}
					else {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5609);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5604);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5601);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W23S22')) {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5617);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W23S22')) {
							if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[7][L], 5610);
						}
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5614);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5611);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S22')) {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5627);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S22')) {
							if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[7][L], 5620);
						}
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5624);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5621);
					}
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S22')) {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5657);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W24S22')) {
							if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[7][L], 5650);
						}
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5654);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5651);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S21')) {
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5667);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W21S21')) {
							if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[7][L], 5660);
						}
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5664);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5661);
					}
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp12 && All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 761);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W59S51')) {
						...
						if(Sp14 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 475);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W52S56')) {
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[7][M], 847);
					}
					else {
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 849);
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 844);
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 841);
// 						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 845);
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 845);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W57S59')) {
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[7][M], 857);
					}
					else {
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 859);
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 854);
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 851);
// 						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 855);
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 855);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W53S56')) {
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[7][M], 867);
					}
					else {
							if(conditions.TO_SPAWN_ROOM_CLAIMER('W53S56')) {
								if(Sp13 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[4][H], 860);
							}
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 869);
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 864);
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 861);
// 						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 865);
						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 865);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W53S53')) {
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[7][M], 877);
					}
					else {
							if(conditions.TO_SPAWN_ROOM_CLAIMER('W53S53')) {
								if(Sp12 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[4][H], 870);
							}
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 879);
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 874);
						if(Sp12 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][L], 871);
// 						if(Sp13 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 875);
