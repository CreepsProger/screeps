...
/*
			...
			if(!spawn.spawning && spawn.name != 'Spawn19') {
				...
				if(false) {
					...
					if(spawn.name == 'Spawn1' || !!rerun) spawns.tryCreateCreep(spawn,             3015, 41, 3); // V 1-1 E    Carier
					...
					if(spawn.name == 'Spawn3' || !!rerun) spawns.tryCreateCreep(spawn,    2000000000002, 50, 1); // V 1-1 E   Claimer
	 				if(spawn.name == 'Spawn2' || !!rerun) spawns.tryCreateCreep(spawn,             3015, 51, 3); // V 1-1 E    Carier
					if(spawn.name == 'Spawn2' || !!rerun) spawns.tryCreateCreep(spawn,           130911, 54, 3); // V 1-1 E    Worker
	        if(spawn.name == 'Spawn2' || !!rerun) spawns.tryCreateCreep(spawn,             3015, 61, 2); // V 1-1 E    Carier
