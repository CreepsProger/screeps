        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
  					...
  					if(Sp1) spawns.tryCreateCreep(spawn, CARIER[7][M], 5011);
						if(spawn.name == 'Spawn1') spawns.tryCreateCreep(spawn, CARIER[1][L], 173);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S28')) {
						...
						if(Sp5)	spawns.tryCreateCreep(spawn, CARIER[7][M], 5121);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S28')) {
						if(Sp5)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5215);
					}
					else {
						if(Sp5)	spawns.tryCreateCreep(spawn, WORKER[7][L], 5214);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[4][H], 5211);
					}
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W23S28')) {
						...
						if(Sp5)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5164);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S27')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[4][M], 5225);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W21S27')) {
							if(Sp6)	spawns.tryCreateCreep(spawn, CLAIMER[4][H], 5220);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[4][H], 5224);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[4][L], 5221);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S28')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[4][M], 5245);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S28')) {
							if(Sp6)	spawns.tryCreateCreep(spawn, CLAIMER[4][H], 5240);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[4][H], 5244);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[4][L], 5241);
					}
        }
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S33')) {
								...
								if(Sp1)	spawns.tryCreateCreep(spawn, WORKER[7][S], 34);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S33')) {
								...
								if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[7][S], 44);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S33')) {
								...
								if(Sp3)	spawns.tryCreateCreep(spawn, WORKER[7][S], 64);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S35')) {
								...
								if(Sp4) spawns.tryCreateCreep(spawn, WORKER[7][S], 124);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S32')) {
								...
								if(Sp5) spawns.tryCreateCreep(spawn,   WORKER[7][S], 174);
							}
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S34')) {
								...
								if(Sp6) spawns.tryCreateCreep(spawn, WORKER[7][S], 84);
							...
							if(spawn.name == 'Spawn9' && (Game.time % 500 < 500) ) spawns.tryCreateCreep(spawn,   CARIER[7][S], 5013);
						}
