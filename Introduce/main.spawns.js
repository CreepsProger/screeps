        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S27')) {
						...
						if(Sp7)	spawns.tryCreateCreep(spawn,   WORKER[6][M], 5194);
						if(Sp7)	spawns.tryCreateCreep(spawn,   CARIER[6][H], 5191);
					}
					/*
					...
					if(spawn.name == 'Spawn10') spawns.tryCreateCreep(spawn,   ATTACKER[10][H], 5267);
					if(spawn.name == 'Spawn16') spawns.tryCreateCreep(spawn,   ATTACKER[10][H], 5267);
					if(spawn.name == 'Spawn9') spawns.tryCreateCreep(spawn,   ATTACKER[10][L], 5265);
					if(spawn.name == 'Spawn16') spawns.tryCreateCreep(spawn,   ATTACKER[10][M], 5266);
					if(spawn.name == 'Spawn10') spawns.tryCreateCreep(spawn,   ATTACKER[10][S], 5264);
        }
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S33')) {
								...
								if(Sp1)	spawns.tryCreateCreep(spawn, WORKER[8][L], 34);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S33')) {
								...
								if(Sp3)	spawns.tryCreateCreep(spawn, WORKER[8][L], 64);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S35')) {
								...
								if(Sp4) spawns.tryCreateCreep(spawn, WORKER[8][L], 124);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S32')) {
								...
								if(Sp5) spawns.tryCreateCreep(spawn,   WORKER[8][L], 174);
