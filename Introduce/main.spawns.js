        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S28')) {
						if(Sp8 && !All)	spawns.tryCreateCreep(spawn, ATTACKER[7][M], 5137);
					}
					else {
						if(Sp8 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][H], 5135);
						if(Sp8 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][H], 5134);
						if(Sp8 && !All)	spawns.tryCreateCreep(spawn, CARIER[7][H], 5131);
					}
            ...
            if(Sp14 && !All)	spawns.tryCreateCreep(spawn,   CARIER[7][L], 5451);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S21')) {
						...
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, UPGRADER[L], 5585);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5584);
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M/*H*/], 5582);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S21')) {
						...
						if(Sp16 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M/*H*/], 5602);
...
// 						if(Sp6 && !All)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5694);
					...
					if(Game.cpu.bucket >= 8000) {
						...
						if(Sp16 && !All && upgrade) spawns.tryCreateCreep(spawn, CARIER[7][L], 5593);
						if(Sp11 && !All && upgrade) spawns.tryCreateCreep(spawn, CARIER[7][H], 5133);
					}
				}
