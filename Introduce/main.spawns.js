        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S27')) {
						...
						if(Sp11)	spawns.tryCreateCreep(spawn, CARIER[7][M], 5141);
						if(Sp8)	spawns.tryCreateCreep(spawn, UPGRADER[H], 5145);
					}
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S26')) {
						if(Sp11)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5306);
					}
					else {
						if(Sp11)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5304);
						if(Sp11)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5301);
					}
				...
				if(Game.shard.name == 'shard0') {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S52')) {
						...
						if(Sp4)	spawns.tryCreateCreep(spawn, CARIER[7][H], 442);
						if(Sp1)	spawns.tryCreateCreep(spawn, UPGRADER[L], 445);
					}
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp5)	spawns.tryCreateCreep(spawn, CARIER[7][M], 551);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S54')) {
						...
						if(Sp4)	spawns.tryCreateCreep(spawn,  WORKER[7][S+1], 564);
            if(Sp4)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 561);
              ...
              if(Sp4)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 590);
						}
