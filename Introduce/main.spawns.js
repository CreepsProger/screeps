...
/*
			...
			if(!spawn.spawning) {
				...
				if(CL >= 5) spawns.tryCreateCreep(spawn,        90909, 39, N<(config.maxCreepsNumber+1)? 5:0); // V 1-1 E  1800   Worker
				...
				if(CL >= 5) spawns.tryCreateCreep(spawn,        90909, 49, N<(config.maxCreepsNumber+1)? 5:0); // V 1-1 E  1800   Worker
 				if(CL >= 4) spawns.tryCreateCreep(spawn,         1709, 50, N<(config.maxCreepsNumber+1)? 3:0); // V 1-1 E  1300   Carier
        ...
        if(CL >= 4) spawns.tryCreateCreep(spawn,         1709, 60, N<(config.maxCreepsNumber+1)? 1:0); // V 1-1 E  1300   Carier
