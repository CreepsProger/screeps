        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S31')) {
						if(Sp12)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5085, 1, 1);
					}
					else {
						if(Sp1)	spawns.tryCreateCreep(spawn, CLAIMER[3][H], 5080, 1, 1);
						if(Sp1)	spawns.tryCreateCreep(spawn,  WORKER[7][M], 5084, 3, 3);
						//if(Sp4)	spawns.tryCreateCreep(spawn, CARIER[5][H], 5081, 2-m+p, 2-m+p);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S29')) {
						...
						if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[7][H], 5024, 1, 1);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S28')) {
						...
						if(Sp1)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5034, 1, 1);
						if(Sp1)	spawns.tryCreateCreep(spawn, CARIER[5][L], 5031, 2-m+p, 2-m+p);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S28')) {
						if(Sp1)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5045, 1, 1);
					}
					else {
						...
						if(Sp1)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5044, 1, 1);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S29')) {
						...
						if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[7][H], 5054, 2-n+r, 2-n+r);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S29')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5065, 1, 1);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W26S29')) {
							if(Sp23)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 5060, 2, 2);
						}
						...
						if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[5][H], 5061, 2-m+p, 2-m+p);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S29')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5075, 1, 1);
					}
					else {
						...
						if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[5][M], 5071, 2-m+p, 2-m+p);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S27')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5105, 1, 1);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W27S27')) {
							if(Sp23)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 5100, 2, 2);
						}
						...
						if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[5][M], 5101, 2-m+p, 2-m+p);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S28')) {
						...
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W27S28')) {
							if(Sp23)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 5110, 2, 2);
						}
						...
						if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[5][M], 5111, 2-m+p, 2-m+p);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S28')) {
						if(Sp3)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5125, 1, 1);
					}
					else {
              ...
              if(Sp2)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 470, 1, 1);
						}
						if(Sp2)	spawns.tryCreateCreep(spawn, WORKER[5][M], 474, 1, 1);
						if(Sp2)	spawns.tryCreateCreep(spawn, CARIER[6][L], 471, 1, 1);
					}
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
						if(Sp12)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 465, 1, 1);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W56S51')) {
              if(Sp1)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 460, 1, 1);
              if(Sp2)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 460, 1, 1);
						}
						if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[5][M], 464, 1, 1);
						if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[6][L], 461, 1, 1);
					}
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W59S51')) {
						if(Sp12)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 485, 1, 1);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W59S51')) {
              if(Sp1)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 480, 1, 1);
              if(Sp2)	spawns.tryCreateCreep(spawn, CLAIMER[6][H], 480, 1, 1);
						}
						if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[5][M], 484, 1, 1);
            if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[6][L], 481, 2, 2);
            if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[6][L], 471, 2, 2);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S52')) {
						...
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W56S52')) {
							if(Sp1)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 440, 1, 1);
						}
						if(Sp1)	spawns.tryCreateCreep(spawn, WORKER[5][M], 444, 1, 1);
						if(Sp1)	spawns.tryCreateCreep(spawn, CARIER[6][L], 441, 1, 1);
					}
					/*
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W55S51')) {
						//if(Sp12)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 495, 1, 1);
					}
					else {
              ...
              //if(Sp2)	spawns.tryCreateCreep(spawn, CLAIMER[5][H], 490, 1, 1);
						...
						//if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[5][M], 494, 1, 1);
            if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[5][M], 491, 1, 1);
            if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[5][M], 461, 3, 3);
					}
					//if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[5][M], 501, 2, 2);
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S33')) {
								...
								if(Sp12)	spawns.tryCreateCreep(spawn, WORKER[7][M], 44, 1+XU, 1+XU);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S33')) {
								...
								if(Sp3)	spawns.tryCreateCreep(spawn, WORKER[7][H], 64, 1+g+XU, 1+g+XU);
	            ...
	            if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S33')) {
	              ...
	              if(Sp23)	spawns.tryCreateCreep(spawn, CARIER[7][M], 51, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S34')) {
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn, ATTACKER[3][L], 85, 1, 1);
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn,   CARIER[7][H], 82, 1, 1);
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn, ATTACKER[7][S+1], 85, 2, 2);
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn, ATTACKER[7][S], 85, 3, 3);
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn,   HEALER[7][H], 87, 1, 1);
							}
							else {
