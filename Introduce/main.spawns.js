        ...
        const CARIER = [ [     0,      0,      0]  // 0  000
				...
				if(false) {
					...
					if(conditions.TO_SPAWN_MAIN_ROOMS()) {
						...
						if(Sp123)	spawns.tryCreateCreep(spawn, WORKER[7][H], 64, 1, 1+X+X);
            ...
            if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S35')) {
              ...
              if(Sp234) spawns.tryCreateCreep(spawn, WORKER[6+X][H], 124, 1, 1+X+X);
              if(Sp34) spawns.tryCreateCreep(spawn, CARIER[6][H], 121, 1, 1);
            }
            ...
            if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S35')) {
              ...
              if(Sp123) spawns.tryCreateCreep(spawn, WORKER[7][H], 134, 1, 1);
              ...
              if(Sp34) spawns.tryCreateCreep(spawn, CARIER[4][H], 141, 1, 1);
							...
							if(conditions.TO_SPAWN_CLAIMING_ROOMS3()) {
								if(conditions.TO_SPAWN_ROOM_DEFENDERS('W28S37')) {
									if(Sp34) spawns.tryCreateCreep(spawn, ATTACKER[L], 155, 1, 1);
