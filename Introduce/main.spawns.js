...
/*
        ...
        spawns.tryCreateCreep(spawn,          2412, 60, 2); // V 1-1 E  1800   Carier
				...
				spawns.tryCreateCreep(spawn, 5000200000007, 64, 1); // V 1-1 E   700 Attacker
				spawns.tryCreateCreep(spawn,         90909, 69, 3); // V 1-1 E  1800   Worker
				spawns.tryCreateCreep(spawn,   20000000002, 71, 0); // V 1-1 E  1300  Claimer
				spawns.tryCreateCreep(spawn,   20000000002, 81, 0); // V 1-1 E  1300  Claimer
				spawns.tryCreateCreep(spawn,   40000000004,101, 2); // V 1-1 E  2600  Claimer
