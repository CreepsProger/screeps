        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S29')) {
						...
						if(Sp2)	spawns.tryCreateCreep(spawn, WORKER[6][M], 5054, 2-n+r, 2-n+r);
						const m = 0+!!flags.flags['-5051'];
						const p = 0+!!flags.flags['5051'];
						if(Sp2)	spawns.tryCreateCreep(spawn, CARIER[5][M], 5051, 2-m+p, 2-m+p);
					}/*
				...
				if(Game.shard.name == 'shard0') {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W57S52')) {
						...
						if(Sp1) spawns.tryCreateCreep(spawn, WORKER[7][H], 404, 2+g, 2+g);
          ...
          if(Sp1)	spawns.tryCreateCreep(spawn, CARIER[6][L], 461, 1, 1);*/
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W26S33')) {
								if(spawn.name == 'Spawn2') spawns.tryCreateCreep(spawn, ATTACKER[2][L], 45, 1, 1);
	            ...
	            if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S33')) {
								if(spawn.name == 'Spawn2') spawns.tryCreateCreep(spawn, ATTACKER[5][L], 55, 1, 1);
	              ...
	              if(Sp23)	spawns.tryCreateCreep(spawn, CARIER[7][M], 51, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S32')) {
								if(spawn.name == 'Spawn5') spawns.tryCreateCreep(spawn, ATTACKER[5][L], 175, 1, 1);
