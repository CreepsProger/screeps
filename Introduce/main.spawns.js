...
var spawns = {
   ...
   work_efficiency: function(type,range) {
	...
	ATTACKER: [ [                 0,                0,                0]  // 0  000
						...
						, [  1000000030000010,  500003005000010,  500300005000010,  500000005100525]//11 
        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S28')) {
						...
						if(Sp6 && !All) spawns.tryCreateCreep(spawn, ATTACKER[11][S], 204);
						...
						if(Sp6 && !All && tm == 1) spawns.tryCreateCreep(spawn, ATTACKER[13][L], 206);
						if(Sp6 && !All && tm == 2) spawns.tryCreateCreep(spawn, ATTACKER[13][M], 207);
						if(Sp6 && !All && tm == 3) spawns.tryCreateCreep(spawn, ATTACKER[13][M], 207);
						if(Sp6 && !All && tm == 4) spawns.tryCreateCreep(spawn, ATTACKER[13][H], 208);
						if(Sp6 && !All && tm == 5) spawns.tryCreateCreep(spawn, ATTACKER[13][H], 208);
