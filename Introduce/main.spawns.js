...
/*
			...
			if(!spawn.spawning) {
				...
				spawns.tryCreateCreep(spawn,         2010, 40, N<(config.maxCreepsNumber+1)? 1:0); // V 1-1 E  1500   Carier
				spawns.tryCreateCreep(spawn,       120408, 49, N<(config.maxCreepsNumber+1)? 4:0); // V 1-1 E  1800   Worker
