...
/*
			...
			if(!spawn.spawning && spawn.name != 'Spawn19') {
				...
				if(false) {
					...
					if(spawn.name == 'Spawn1' || !!rerun) spawns.tryCreateCreep(spawn,             1608, 31, 1); // V 1-1 E    Carier
...
// 					if(spawn.name == 'Spawn2' || !!rerun) spawns.tryCreateCreep(spawn,  500100000000015, 87, 3); // V 1-2 E  RAttacker
          ...
          if(spawn.name == 'Spawn3' || !!rerun) spawns.tryCreateCreep(spawn,           060606, 94, 2); // V 1-1 E    Worker
