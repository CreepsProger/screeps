        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S28')) {
						...
						if(Sp23)	spawns.tryCreateCreep(spawn, WORKER[7][H], 5124, !W?1:11-W.color, !W?1:11-W.secondaryColor);
						const C = flags.flags['5121'];
						if(Sp23)	spawns.tryCreateCreep(spawn, CARIER[7][M], 5121, !C?1:11-C.color, !C?1:11-C.secondaryColor);
					}
	            ...
	            if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S33')) {
	              ...
	              if(Sp23)	spawns.tryCreateCreep(spawn, CARIER[7][M], 51, 1, 1);
							...
							if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S34')) {
								...
								if(Sp6) spawns.tryCreateCreep(spawn, WORKER[7][M], 84, !W?1:11-W.color, !W?1:11-W.secondaryColor);
