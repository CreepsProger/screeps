        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S28')) {
						...
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[6][H], 5214);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S29')) {
						...
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S29')) {
							if(Sp6)	spawns.tryCreateCreep(spawn, CLAIMER[6][M], 5230);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[6][S], 5234);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[6][L], 5231);
					}
					/*
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W55S51')) {
              ...
              if(Sp2)	spawns.tryCreateCreep(spawn, CLAIMER[7][H], 460);
						...
						if(Sp3)	spawns.tryCreateCreep(spawn, WORKER[4][M], 464);
						if(Sp3)	spawns.tryCreateCreep(spawn, CARIER[4][L], 461); // 3
					}
				...
				if(Game.shard.name == 'shard3') {
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							...
							if(Sp4 && (Game.time % 10000 < 100) ) spawns.tryCreateCreep(spawn, HEALER[8][L], 217);
							if(Sp4 && (Game.time % 1000 < 100) ) spawns.tryCreateCreep(spawn, CARIER[1][L], 211);
						}
