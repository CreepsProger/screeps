...
var spawns = {
   ...
   work_efficiency: function(type,range) {
	...
	ATTACKER: [ [                 0,                0,                0]  // 0  000
						...
						, [  1300000027000010, 1300001021000006, 1300100021000006, 1300000021100006]//11 
        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
  					if(Sp1)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5016);
						...
						if(Sp1) spawns.tryCreateCreep(spawn, WORKER[7][M], 5014);
            ...
            if(Sp14)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 5451);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S29')) {
						...
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W21S29')) {
							if(Sp6 && !All)	spawns.tryCreateCreep(spawn, CLAIMER[8][H], 5400);
						}
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S23')) {
						...
						if(Sp6)	spawns.tryCreateCreep(spawn, UPGRADER[M], 5415);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S24')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5427);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S24')) {
							if(Sp6)	spawns.tryCreateCreep(spawn, CLAIMER[7][M], 5420);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5424);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5421);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S22')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5437);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S22')) {
							if(Sp6)	spawns.tryCreateCreep(spawn, CLAIMER[7][M], 5430);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5434);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5431);
					}
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W22S23')) {
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5447);
					}
					else {
						if(conditions.TO_SPAWN_ROOM_CLAIMER('W22S23')) {
							if(Sp6)	spawns.tryCreateCreep(spawn, CLAIMER[7][M], 5440);
						}
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[5][M], 5444);
						if(Sp6)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5441);
					}
        }
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp5)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 681);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W57S55')) {
						...
						if(Sp10)	spawns.tryCreateCreep(spawn, WORKER[6][M], 654);
            if(Sp10)	spawns.tryCreateCreep(spawn, CARIER[6][H], 651);
						// if(Sp10)	spawns.tryCreateCreep(spawn,  UPGRADER[L], 655);
						if(Sp10)	spawns.tryCreateCreep(spawn, WORKER[6][H], 655);
					}
            ...
            if(Sp9)	spawns.tryCreateCreep(spawn, CARIER[6][L], 721);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W59S54')) {
						if(Sp9)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 736);
					}
					else {
            ...
            if(Sp9)	spawns.tryCreateCreep(spawn, CARIER[6][L], 731);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W58S55')) {
						if(Sp9)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 746);
					}
					else {
            ...
            if(Sp10)	spawns.tryCreateCreep(spawn, CARIER[6][L], 751);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W54S557')) {
						...
						if(Sp7)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 766);
						if(Sp7)	spawns.tryCreateCreep(spawn, WORKER[7][M], 764);
						if(Sp7)	spawns.tryCreateCreep(spawn, WORKER[7][L], 765);
