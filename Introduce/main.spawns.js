        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W25S27')) {
						if(Sp5)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5206);
					}
					else {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W24S27')) {
						...
						if(Sp5)	spawns.tryCreateCreep(spawn,   WORKER[7][L], 5194);
						if(Sp7)	spawns.tryCreateCreep(spawn,   CARIER[4][H], 5191);
						if(Sp5)	spawns.tryCreateCreep(spawn, ATTACKER[5][M], 5195);
					}
					/*
				...
				if(Game.shard.name == 'shard3') {
					...
					if(false) {
						...
						if(conditions.TO_SPAWN_MAIN_ROOMS()) {
							...
							if(Sp2) spawns.tryCreateCreep(spawn, ATTACKER[10][S], 84);
							if(Sp2) spawns.tryCreateCreep(spawn, ATTACKER[8][H+4], 86);
						}
