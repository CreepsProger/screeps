        ...
        if(Game.shard.name == 'shard1') {
  				...
  				if(conditions.TO_SPAWN_ROOM_DEFENDERS('W29S29')) {
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W27S26')) {
						...
						if(Sp12)	spawns.tryCreateCreep(spawn, UPGRADER[S], 5145);
						if(Sp12)	spawns.tryCreateCreep(spawn, CARIER[7][L], 5142);
					}
          ...
          if(conditions.TO_SPAWN_ROOM_DEFENDERS('W56S51')) {
            ...
            if(Sp7)	spawns.tryCreateCreep(spawn, CARIER[7][L], 571);
						if(Sp7)	spawns.tryCreateCreep(spawn,  UPGRADER[S], 575);
					}
            ...
            if(Sp7)	spawns.tryCreateCreep(spawn, CARIER[7][H], 591);
						if(Sp7)	spawns.tryCreateCreep(spawn,  UPGRADER[S], 595);
					}
...
// 								if(spawn.name == 'Spawn13') spawns.tryCreateCreep(spawn, DEFENDER[12][D], 176);
							...
							if(spawn.name == 'Spawn10') spawns.tryCreateCreep(spawn,   CARIER[8][L], 5013);
