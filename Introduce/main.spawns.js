        ...
        if(Game.shard.name == 'shard1') {
            ...
            if(Sp14)	spawns.tryCreateCreep(spawn,  CARIER[7][L], 5451);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S29')) {
						...
						if(Sp6)	spawns.tryCreateCreep(spawn, WORKER[7][M], 5402);
					...
					if(conditions.TO_SPAWN_ROOM_DEFENDERS('W21S23')) {
						...
						if(Sp15)	spawns.tryCreateCreep(spawn, ATTACKER[7][M], 5366);
						if(Sp6)	spawns.tryCreateCreep(spawn, ATTACKER[6][M], 5366);
						if(Sp15)	spawns.tryCreateCreep(spawn, WORKER[6][M], 5412);
						if(Sp6)		spawns.tryCreateCreep(spawn, WORKER[7][M], 5412);
						if(Sp15)	spawns.tryCreateCreep(spawn, WORKER[6][H], 5414);
						if(Sp6)		spawns.tryCreateCreep(spawn, WORKER[7][M], 5414);
						if(Sp15)	spawns.tryCreateCreep(spawn, CARIER[6][H], 5411);
						if(Sp6)		spawns.tryCreateCreep(spawn, CARIER[7][L], 5411);
						//if(Sp15)	spawns.tryCreateCreep(spawn, UPGRADER[L], 5415);
						if(Sp15)	spawns.tryCreateCreep(spawn, WORKER[6][H], 5415);
						if(Sp6)		spawns.tryCreateCreep(spawn, WORKER[7][L], 5415);
					}
