...
/*
			...
			if(!spawn.spawning) {
				...
				spawns.tryCreateCreep(spawn,         2412, 40, N<(config.maxCreepsNumber+1)? 1:0); // V 1-1 E  1800   Carier
				...
				spawns.tryCreateCreep(spawn,  20000000002, 50, N<(config.maxCreepsNumber+1)? 1:0); // V 1-1 E  1300  Claimer
 				spawns.tryCreateCreep(spawn,         2412, 51, N<(config.maxCreepsNumber+1)? 2:0); // V 1-1 E  1800   Carier
        ...
        spawns.tryCreateCreep(spawn,         2412, 61, N<(config.maxCreepsNumber+1)? 2:0); // V 1-1 E  1800   Carier
