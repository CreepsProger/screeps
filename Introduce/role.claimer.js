...
var roleClaimer = {
	...
	/** @param {Creep} creep **/
	run: function(creep) {
		if(!creep.memory.claiming && !creep.memory.claiming.on)
		{
			...
			console.log(typeof creep.memory.claiming);
			console.log(typeof creep.memory.claiming.on);
			console.log(typeof creep.memory.claiming.off);
		}
