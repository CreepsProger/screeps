...
module.exports.loop = function () {
	...
	Memory.targets = {};
	Memory.cpu = {dt_max: 0, name_max: '', dt_max_role: 0, role_creep_max: '', role_max: '', t: Game.cpu.getUsed(), t_role: Game.cpu.getUsed(), dt: 0, creep: metrix.cpu.creep, role: metrix.cpu.role};
