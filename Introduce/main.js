...
//      if(((Memory.totals.CreepsNumber < 8) || (2 * Memory.totals.FreeCapacity <=  Memory.totals.UsedCapacity)) && !Spawn.spawning) {
      if(!Spawn.spawning) {
         ...
         if(CL >= 5) mainFlags.tryCreateCreep(        90909, N<(maxCreepsNumber+1)? 5:0,   40); // V 1-1 E  1800   Worker
         if(CL >= 5) mainFlags.tryCreateCreep(        90909, N<(maxCreepsNumber+1)?12:0,   50); // V 1-1 E  1800   Worker
