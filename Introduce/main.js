...
module.exports.loop = function () {
	...
	Game.cpu.setShardLimits({shard0:60,shard1:0,shard2:0,shard3:20});
	...
	if(Game.time % constants.TICKS_TO_CHECK_CPU_MAIN_PART == 0 && Memory.cpu_main_part_dt > constants.TICKS_TO_CHECK_CPU_MAIN_PART) {
		...
		Memory.cpu_main_part = {perf:0, clearing:0, metrix:0, config:0, flags:0, event_processor:0, links:0, towers:0, spawns:0, terminals:0, metrix2:0, others:0};
	}
